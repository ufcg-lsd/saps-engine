...
function executeDockerContainer {
  ...
  docker exec $CONTAINER_ID bash -x $BIN_RUN_SCRIPT ${IMAGE_NEW_COLLECTION_NAME} ${SEBAL_MOUNT_POINT}/ ${SEBAL_MOUNT_POINT}/ ${SEBAL_MOUNT_POINT}/${IMAGE_NEW_COLLECTION_NAME}/$OUTPUT_DIR_NAME ${SEBAL_MOUNT_POINT}/${IMAGE_NEW_COLLECTION_NAME}/$INPUTS_DIR_NAME/${IMAGE_NEW_COLLECTION_NAME}"_MTL.txt" ${SEBAL_MOUNT_POINT}/${IMAGE_NEW_COLLECTION_NAME}/$INPUTS_DIR_NAME/${IMAGE_NEW_COLLECTION_NAME}"_station.csv"
}
