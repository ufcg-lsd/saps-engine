...
function executeDockerContainer {
  ...
  docker exec $CONTAINER_ID bash -x $BIN_RUN_SCRIPT ${IMAGE_NEW_COLLECTION_NAME} ${SEBAL_MOUNT_POINT}/${IMAGE_NEW_COLLECTION_NAME}/$INPUTS_DIR_NAME ${SEBAL_MOUNT_POINT}/${IMAGE_NEW_COLLECTION_NAME}/$OUTPUT_DIR_NAME ${SEBAL_MOUNT_POINT}/${IMAGE_NEW_COLLECTION_NAME}/$INPUTS_DIR_NAME ${SEBAL_MOUNT_POINT}/${IMAGE_NEW_COLLECTION_NAME}/$PREPROCESSING_DIR_NAME
}
