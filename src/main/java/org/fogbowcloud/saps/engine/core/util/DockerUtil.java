...
public class DockerUtil {
     ...
     * @param repositoryTag        The tag name.
     ...
     *
     * @param containerId The container ID to be removed.
     ...
     *
     * @param imageName The image name (or id) to be killed.
     * @return True, if it was successfully removed, otherwise, False.
     */
    ...
    /**
     * Executes a given command inside a Docker container.
     * @param type The type, if image or container.
     * @param filter Word to be filtered.
     * @return The exit value.
     */
