...
public class DefaultImageRepository implements INPERepository {
	
	Properties properties;	
	public static final Logger LOGGER = Logger.getLogger(DefaultImageRepository.class);

	public DefaultImageRepository(Properties properties) {
