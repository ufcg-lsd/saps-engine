...
public class Archiver {
    ...
    public void start() throws ArchiverException {
        ...
        sapsExecutor.scheduleWithFixedDelay(this::gc, 0, gcDelayPeriod,
                TimeUnit.SECONDS);
    ...
    /**
     * It deletes the data generated by {@code ImageTaskState.FAILED} tasks in temporary storage.
     */
    private void gc() {
        //FIXME: what is this message? this method can fail?
        ...
        failedTasks.forEach(this::deleteTaskTempData);
    }
    ...
    private void resetArchivingTasks() throws ArchiverException {
        //FXIME: can this getTasks method fail?
