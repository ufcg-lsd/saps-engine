...
public class ArchiverMain {
	...
	private static Archiver createArchiver(Properties properties) throws SapsException {
	...
	private static PermanentStorage createPermanentStorage(Properties properties) throws SapsException {
