...
public class ProcessedImagesEmailBuilder implements Runnable {
    ...
    JSONObject generateTaskEmailJson(Properties properties, String imageid)
        ...
        SapsImage task = application.getTask(imageid);
    ...
    List<String> getTaskFilesFromObjectStore(Properties properties, String objectStoreHost, String objectStorePath, String objectStoreContainer, SapsImage task) throws URISyntaxException, IOException {
    ...
    private HttpGet prepObjectStoreRequest(String objectStoreHost, String objectStorePath, String objectStoreContainer, SapsImage task, Token token) throws URISyntaxException {
