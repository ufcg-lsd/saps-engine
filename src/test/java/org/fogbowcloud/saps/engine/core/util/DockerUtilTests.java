...
public class DockerUtilTests {
    ...
    public void setUp(){
        repository = "ubuntu";
        tag = "latest";
        containerPath = File.separator + "home" + File.separator + "tmp" + File.separator + "sapsTest";
    ...
    public void commandExecAndRunMappedDockerTest(){
        ...
        String containerId = DockerUtil.runMappedContainer(repository, tag, hostPath, containerPath);
