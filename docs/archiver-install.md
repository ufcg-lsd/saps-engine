...
The second part is the customization of the [archiver.conf](/config/archiver.conf) file allowing to interact with other components, including the SAPS Catalog, temporary and permanent storage pools.
